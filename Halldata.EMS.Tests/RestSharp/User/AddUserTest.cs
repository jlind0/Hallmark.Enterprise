...
namespace HallData.EMS.Tests.User
{
	...
	public class AddUserTest
	{
		...
		public void AddUser()
		{
			...
			request.AddParameter("text/json", "{\"PrimaryEmail\": {\"ContactMechanismTypeName\": \"Work\",\"EmailAddress\": \"brtest007@test.com\"},\"Username\": \"BRtestWed01v2\",\"Password\": \"test123456\",\"FirstName\": \"Brandon\",\"LastName\": \"Rogers\",\"Status\": {\"StatusTypeId\":3}}", ParameterType.RequestBody);
