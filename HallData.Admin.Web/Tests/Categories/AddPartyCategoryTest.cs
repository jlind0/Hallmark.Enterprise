...
{
	[TestClass]
	public class AddPartyCategoryTest
	{
		...
		[TestMethod]
		public void AddPartyCategory()
		{
			string sessionId = createSession();
			string resource = "/HallData.EMS.Web/api/partycategories/TypedView";

			RestClient client = new RestClient(this.baseUrl);
			RestRequest request = new RestRequest(resource, Method.POST);
			request.Timeout = 600000;
			request.AddParameter("text/json", "{\"PartyGuid\": \"B522CE71-F0CF-45D5-A88A-61DACD644886\",\"Id\": 165,\"RoleId\": 3,\"OrderIndex\": 1,\"IsDefault\": true,\"Status\": { \"StatusTypeId\": 3 }}", ParameterType.RequestBody);
