...
namespace Microsoft {
	...
	public partial class TranslatorContainer : System.Data.Services.Client.DataServiceContext {
		...
		public TranslatorContainer() : base(new Uri("http://localhost")) { }
		...
		public virtual DataServiceQuery<Translation> Translate(String Text, String To, String From) {
			if ((Text == null)) {
		...
		/// <summary>
		/// </summary>
		public virtual DataServiceQuery<Language> GetLanguagesForTranslation()
		{
		...
		public virtual DataServiceQuery<DetectedLanguage> Detect(String Text)
		{
			if ((Text == null)) {
				throw new System.ArgumentNullException("Text", "Text value cannot be null");
			}
